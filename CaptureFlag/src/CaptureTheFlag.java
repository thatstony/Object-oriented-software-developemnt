...
public class CaptureTheFlag{
  ...
  public static void main(String[] args){
    ...
    Team blues = new Team(f, 2, 2, 2, 2);
    Team reds = new Team(f, 1, 2, 2, 3);

/*    Player p,q;
    
    int NUM_PLAYERS = 25;
    p = new RandomWalker(f, 1, "Cat van Kittenish", 12, "blues", 'b', Math.random()*400+10, Math.random()*500+10);
//    q = new Chaser(f, 2, "Bunny El-Amin", 7, "reds", 'r', Math.random()*400+410, Math.random()*500+10, p);
  Catcher catcher = new Catcher(f, 2, "Bunny El-Amin", 7, "reds", 'r', Math.random()*400+410, Math.random()*500+10);
